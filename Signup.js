    ...
    render() {
        return (
            <View className="col-lg-3 col-md-3 mx-auto my-5 py-5 px-4 bg-white shadow mb-5 border border-light">
                <View id="signUpForm">
                    <Text className="h1 text-center text-dark mb-4">Sign Up</Text>
                    <View className="form-group">
                        <label htmlFor="userFullName">Full name<Text className="text-danger ml-1">*</Text></label>
                    ...
                    <View className="mb-3">
                        <View className="custom-control custom-radio custom-control-inline">
                    ...
                    <Paragraph>Already have an account? Click here</Paragraph>
